...
#include "src/mapping/sparse_pose_graph/constraint_builder.h"
#include "src/mapping/sparse_pose_graph/optimization_problem.h"
#include "src/mapping/submaps.h"
//#include "src/sensor/fixed_frame_pose_data.h"
...
class SparsePoseGraph2D : public mapping::SparsePoseGraph {
 public:
    SparsePoseGraph2D(const mapping::proto::SparsePoseGraphOptions& options,
                  common::ThreadPool* thread_pool);
  ~SparsePoseGraph2D() override;

  SparsePoseGraph2D(const SparsePoseGraph2D&) = delete;
  SparsePoseGraph2D& operator=(const SparsePoseGraph2D&) = delete;
 ...
 private:
  ...
  // public:
  //  TrimmingHandle(SparsePoseGraph2D* parent);
...
//
  // private:
  //  SparsePoseGraph2D* const parent_;
  //};
};
