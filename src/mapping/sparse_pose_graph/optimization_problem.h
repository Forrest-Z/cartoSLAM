...
#ifndef CARTOGRAPHER_MAPPING_SPARSE_POSE_GRAPH_OPTIMIZATION_PROBLEM_H_
#define CARTOGRAPHER_MAPPING_SPARSE_POSE_GRAPH_OPTIMIZATION_PROBLEM_H_
...
class OptimizationProblem {
 public:
  ...
  void AddTrajectoryNode(int trajectory_id, double time,
  ...
  const std::vector<std::map<int, SubmapPoseData>>& submap_data() const;
 ...
 private:
  ...
  std::vector<std::map<int, SubmapPoseData>> submap_data_;
...
#endif  // CARTOGRAPHER_MAPPING_SPARSE_POSE_GRAPH_OPTIMIZATION_PROBLEM_H_
