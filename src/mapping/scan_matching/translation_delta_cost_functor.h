...
#ifndef CARTOGRAPHER_mapping_SCAN_MATCHING_TRANSLATION_DELTA_COST_FUNCTOR_H_
#define CARTOGRAPHER_mapping_SCAN_MATCHING_TRANSLATION_DELTA_COST_FUNCTOR_H_
...
#endif  // CARTOGRAPHER_mapping_SCAN_MATCHING_TRANSLATION_DELTA_COST_FUNCTOR_H_
